...
# 2. एडवांस CSS: रॉयल क्रिमसन रेड, नियॉन रोज़ गोल्ड और फुल-स्क्रीन हार्ट एनीमेशन
custom_css = """
<style>
    ...
    /* मुख्य कंटेनर को मोबाइल स्क्रीन की हाइट में एकदम सटीक फिट करने के लिए */
    .block-container {
    ...
    /* सबसे ऊपर दिखने वाला जादुई लव संदेश (Prabhat Wishes To His Lifeline Laxmi) */
    .love-sender-box {
        text-align: center;
        margin-top: 5px;
        margin-bottom: 12px;
    ...
    /* इमेज के चारों तरफ का धड़कता हुआ लव नियॉन बॉर्डर (Heartbeat Glow Frame) */
    .stImage img {
        display: block;
        margin-left: auto;
        margin-right: auto;
        ...
        animation: romanticFloat 4s ease-in-out infinite, pulseLove 3s ease-in-out infinite alternate !important;
    }

    /* नीचे का प्रीमियम लव कोट्स बॉक्स जिसके टेक्स्ट लाइव चमकेंगे */
    .wishes-container {
    ...
    /* एनीमेशन के नियम */
    @keyframes pulseLove {
        0% { box-shadow: 0px 0px 15px #ff0055, 0px 0px 5px #ff80b3 !important; }
        100% { box-shadow: 0px 0px 35px #FFD700, 0px 0px 15px #ff0055 !important; }
    }
...
# 6. जादू: गिटहब फोल्डर में मौजूद किसी भी इमेज को ऑटोमैटिक ढूंढकर लोड करना
all_files = os.listdir(".")
found_image = None

# कोड और आवश्यकताओं की फ़ाइलों को छोड़कर, यह कोई भी .jpeg, .jpg या .png फ़ाइल ढूंढ लेगा
for file in all_files:
    if file.lower().endswith((".jpeg", ".jpg", ".png")) and "images (52)" not in file:
        found_image = file
        break
...
if found_image:
    ...
    st.warning("कृपया अपनी लक्ष्मी जी की फोटो को गिटहब पर अपलोड करें।")

# 7. नीचे का सबसे खूबसूरत और गहरा रोमांटिक लव कोट्स बॉक्स
st.markdown(
    """
...
# 8. आसमान से जादुई सितारों और बर्फ के कणों का रोमांटिक गिरना चालू
st.snow()
